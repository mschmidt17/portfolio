      ...
      <header id="home" className='header'>
         <nav id="nav-wrap" className='nav'>
            <ul id="nav" className="navBar">
                ...
                <li><a className={`smoothscroll${light==='light' ? '' : '-dark'}`} href="#about">Sobre mi</a></li>
            ...
            <div className='socials-header'>
                <a className={`social${light==='light' ? '' : '-dark'}`} href='https://www.linkedin.com/in/matias-schmidt1/' target='_blank' rel='noreferrer'> <BsLinkedin/> </a>
                <a className={`social${light==='light' ? '' : '-dark'}`}  href='https://github.com/mschmidt17' target='_blank' rel='noreferrer'> <BsGithub/> </a>
                <a className={`social${light==='light' ? '' : '-dark'}`}  href='https://www.instagram.com/mati_schmidt1/' target='_blank' rel='noreferrer'> <BsInstagram/> </a>
                {light==='light'?
